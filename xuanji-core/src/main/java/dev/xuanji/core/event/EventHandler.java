 ...
 * <h3>现有实现</h3>
 * <ul>
 *   <li>{@link dev.xuanji.core.event.handler.C2cMessageHandler} — 单聊消息</li>
 *   <li>{@link dev.xuanji.core.event.handler.GroupMessageHandler} — 群聊消息</li>
 *   <li>{@link dev.xuanji.core.event.handler.GuildMessageHandler} — 频道消息</li>
 *   <li>{@link dev.xuanji.core.event.handler.DmsMessageHandler} — 频道私信</li>
 *   <li>{@link dev.xuanji.core.event.handler.FriendEventHandler} — 好友事件</li>
 *   <li>{@link dev.xuanji.core.event.handler.GroupEventHandler} — 群事件</li>
 *   <li>{@link dev.xuanji.core.event.handler.AudioEventHandler} — 音频事件</li>
 *   <li>{@link dev.xuanji.core.event.handler.ForumEventHandler} — 论坛事件</li>
 *   <li>{@link dev.xuanji.core.event.handler.MessageDeleteHandler} — 消息删除</li>
 *   <li>{@link dev.xuanji.core.event.handler.SystemEventHandler} — 系统事件</li>
 *   <li>{@link dev.xuanji.core.event.handler.InteractionEventHandler} — 交互事件</li>
 * </ul>
 *
