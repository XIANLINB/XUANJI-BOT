...
public class LogDbConfig {
    ...
    private final ObjectProvider<XuanJi.core.config.ConfigService> configProvider;

    public LogDbConfig(ObjectProvider<XuanJi.core.config.ConfigService> configProvider) {
    ...
    private int poolSize(String key, int def) {
        try {
            XuanJi.core.config.ConfigService cs = configProvider.getIfAvailable();
            if (cs != null) {
