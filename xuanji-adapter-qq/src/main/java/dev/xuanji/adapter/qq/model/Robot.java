 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link dev.xuanji.adapter.qq.registry.RobotRegistry} — 注册表中缓存机器人配置</li>
 *   <li>{@link dev.xuanji.adapter.qq.webhook.WebhookController} — Webhook 入口查找机器人</li>
 *   <li>{@link dev.xuanji.adapter.qq.api.QqApiService} — API 调用时获取凭证</li>
 *   <li>{@link dev.xuanji.adapter.qq.websocket.QqBotWsManager} — WebSocket 连接时获取凭证</li>
 * </ul>
 *
 * <h3>字段说明</h3>
 * <ul>
