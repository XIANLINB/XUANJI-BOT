 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link dev.xuanji.adapter.qq.api.QqApiService} — API 调用时获取 Token</li>
 *   <li>{@link dev.xuanji.adapter.qq.websocket.GatewayService} — 获取网关地址时获取 Token</li>
 *   <li>{@link dev.xuanji.adapter.qq.websocket.QqBotWsClient} — WebSocket 鉴权时获取 Token</li>
 * </ul>
 *
