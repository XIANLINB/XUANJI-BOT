package dev.xuanji.adapter.qq.config;
 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link dev.xuanji.adapter.qq.api.QqApiService} — API 调用时选择基地址</li>
 *   <li>{@link dev.xuanji.adapter.qq.websocket.GatewayService} — 获取网关地址时选择基地址</li>
 *   <li>{@link dev.xuanji.adapter.qq.registry.AccessTokenServiceImpl} — 获取 Token 时选择接口地址</li>
 * </ul>
 */
public final class QqPlatformConfig {
     ...
     * <p>包含以下事件：
     * <ul>
     *   <li>GROUP_MEMBER_EVENT (1 << 24) — 群成员加入/退出</li>
     *   <li>GROUP_AND_C2C_EVENT (1 << 25) — 群聊/单聊消息和事件</li>
     *   <li>INTERACTION (1 << 26) — 互动事件（按钮点击等）</li>
     * </ul>
     */
