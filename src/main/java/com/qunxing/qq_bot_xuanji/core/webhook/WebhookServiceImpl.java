package com.qunxing.qq_bot_xuanji.core.webhook;
...
import com.qunxing.qq_bot_xuanji.core.webhook.WebhookPayload;
import com.qunxing.qq_bot_xuanji.core.webhook.WebhookService;
import com.qunxing.qq_bot_xuanji.core.webhook.SignatureVerifier;
 ...
 * 与 WebSocket 模式共享同一个 {@link EventDispatcher} 进行事件分发。
 *
 * <h3>处理流程</h3>
 * <ol>
...
public class WebhookServiceImpl implements WebhookService {
    ...
    public String handleWebhook(Long robotId, String envType, String body,
        ...
        if (payload.getOp() == 13) {
            // ===== 回调地址验证（OpCode 13）=====
            // QQ 平台首次注册回调地址时发送此请求
            JSONObject d = payload.getD();
            String plainToken = d.optString("plain_token", "");
            String eventTs = d.optString("event_ts", "");
