 ...
 * 与 {@link com.qunxing.qq_bot_xuanji.core.websocket.WsPayload} 结构类似，
 ...
 * @see com.qunxing.qq_bot_xuanji.core.websocket.WsPayload WebSocket 消息结构（对比参考）
 */
@Data
public class WebhookPayload {
    ...
    public static WebhookPayload parse(String jsonStr) {
        ...
        payload.setId(json.optString("id", null));
        payload.setOp(json.optInt("op", 0));
        payload.setD(json.optJSONObject("d"));
        payload.setS(json.has("s") ? json.optInt("s") : null);
        payload.setT(json.optString("t", null));
        return payload;
    }
}
