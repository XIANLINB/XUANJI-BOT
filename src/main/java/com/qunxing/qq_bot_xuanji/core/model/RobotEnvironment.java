package com.qunxing.qq_bot_xuanji.core.model;
 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link com.qunxing.qq_bot_xuanji.registry.RobotRegistry} — 注册表中缓存环境配置</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.webhook.SignatureVerifier} — 使用 ed25519Secret 进行签名验证</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.webhook.WebhookServiceImpl} — 使用环境配置处理事件</li>
 * </ul>
 *
 * <h3>连接模式</h3>
...
public class RobotEnvironment {
    ...
    /**
     * Ed25519 密钥（AES 加密存储）
     * <p>用于 Webhook 签名验证。在 {@link com.qunxing.qq_bot_xuanji.core.webhook.SignatureVerifier}
     * 注册时通过 {@link com.qunxing.qq_bot_xuanji.security.util.AesUtil} 解密。
