 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link com.qunxing.qq_bot_xuanji.registry.RobotRegistry} — 注册表中缓存机器人配置</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.webhook.WebhookController} — Webhook 入口查找机器人</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.api.QqApiService} — API 调用时获取凭证</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.websocket.QqBotWsManager} — WebSocket 连接时获取凭证</li>
 * </ul>
 *
 * <h3>字段说明</h3>
 * <ul>
...
public class Robot {
     ...
     * 使用前需要通过 {@link com.qunxing.qq_bot_xuanji.security.util.AesUtil} 解密。
     */
