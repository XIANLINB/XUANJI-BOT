 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.api.QqApiService} — API 调用时选择基地址</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.websocket.GatewayService} — 获取网关地址时选择基地址</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.registry.AccessTokenServiceImpl} — 获取 Token 时选择接口地址</li>
 * </ul>
 */
