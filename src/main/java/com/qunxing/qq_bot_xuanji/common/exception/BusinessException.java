 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.api.QqApiService} — QQ 平台 API 调用失败时抛出</li>
 *   <li>事件 Handler — 业务逻辑校验失败时抛出</li>
 *   <li>由 {@link com.qunxing.qq_bot_xuanji.common.exception.GlobalExceptionHandler} 统一捕获并返回给前端</li>
 * </ul>
 *
 * <h3>错误码约定</h3>
 * <ul>
