...
public class MsgBuilder {
    ...
    public static class MarkdownMsgBuilder {
         ...
         */
        public JSONObject buildMarkdownJson() {
            JSONObject mdObj = new JSONObject();
            mdObj.put("custom_template_id", JSONObject.NULL);
            mdObj.put("params", JSONObject.NULL);
         ...
         */
        public SendMessageRequest buildActive() {
            JSONObject mdJson = buildMarkdownJson();
            JSONObject kbJson = keyboardBuilder != null ? new JSONObject(keyboardBuilder.build()) : null;
    ...
    public static class ArkMsgBuilder {
        ...
        private final List<JSONObject> kvList = new ArrayList<>();
