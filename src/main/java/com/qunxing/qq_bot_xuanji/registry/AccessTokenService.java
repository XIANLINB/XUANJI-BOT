 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.api.QqApiService} — API 调用时获取 Token</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.websocket.GatewayService} — 获取网关地址时获取 Token</li>
 *   <li>{@link com.qunxing.qq_bot_xuanji.core.websocket.QqBotWsClient} — WebSocket 鉴权时获取 Token</li>
 * </ul>
 *
