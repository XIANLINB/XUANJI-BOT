package com.qunxing.qq_bot_xuanji.event.handler.group;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.qunxing.qq_bot_xuanji.common.config.XuanjiRobotProperties;
import com.qunxing.qq_bot_xuanji.common.dto.GroupMessageEvent;
...
import com.qunxing.qq_bot_xuanji.utils.KeyboardBuilder;
import com.qunxing.qq_bot_xuanji.utils.MarkdownBuilder;
...
public class GroupMessageHandler implements EventHandler {
    ...
    private void testMarkdown(String groupOpenid, String msgId) {
        ...
        messageSender.sendGroupMarkdown(groupOpenid, new JSONObject(md), null, msgId);
    }
    ...
    private void testMarkdownWithKeyboard(String groupOpenid, String msgId) {
        ...
        messageSender.sendGroupMarkdown(groupOpenid, new JSONObject(md), new JSONObject(kb), msgId);
    }
    ...
    private void testArk23(String groupOpenid, String msgId) {
        ...
        kv.put(new JSONObject().put("key", "#LIST#").put("value", "功能1|功能2|功能3"));
        kv.put(new JSONObject().put("key", "#DESC#").put("value", "璇玑机器人功能列表"));
        kv.put(new JSONObject().put("key", "#PROMPT#").put("value", "请选择功能"));
        kv.put(new JSONObject().put("key", "#TITLE#").put("value", "璇玑机器人"));
        kv.put(new JSONObject().put("key", "#LINK#").put("value", "https://bot.q.qq.com"));
        kv.put(new JSONObject().put("key", "#METATITLE#").put("value", "官方文档"));
        kv.put(new JSONObject().put("key", "#METADESC#").put("value", "QQ 机器人开放平台"));
        kv.put(new JSONObject().put("key", "#METAICON#").put("value", "https://q.qlogo.cn/g?b=qq&nk=10001&s=100"));
        ark.put("kv", kv);
    ...
    private void testArk24(String groupOpenid, String msgId) {
        ...
        JSONArray kv = new JSONArray();
        kv.put(new JSONObject().put("key", "#DESC#").put("value", "这是一条 Ark 测试消息"));
        kv.put(new JSONObject().put("key", "#PROMPT#").put("value", "Ark 模板24"));
        kv.put(new JSONObject().put("key", "#TITLE#").put("value", "文本+缩略图模板"));
        kv.put(new JSONObject().put("key", "#METADESC#").put("value", "支持多种 Ark 模板消息"));
        kv.put(new JSONObject().put("key", "#IMG#").put("value", "https://c-ssl.duitang.com/uploads/blog/202605/05/3BS4exw0czd3Vlg.jpg"));
        kv.put(new JSONObject().put("key", "#LINK#").put("value", "https://c-ssl.duitang.com/uploads/blog/202605/05/3BS4exw0czd3Vlg.jpg"));
        kv.put(new JSONObject().put("key", "#SUBTITLE#").put("value", "璇玑机器人"));
        ark.put("kv", kv);
    ...
    private void testArk37(String groupOpenid, String msgId) {
        ...
        JSONArray kv = new JSONArray();
        kv.put(new JSONObject().put("key", "#PROMPT#").put("value", "Ark 模板37"));
        kv.put(new JSONObject().put("key", "#METATITLE#").put("value", "豆包机器人"));
        kv.put(new JSONObject().put("key", "#METASUBTITLE#").put("value", "非常好用"));
        kv.put(new JSONObject().put("key", "#METACOVER#").put("value", "https://c-ssl.duitang.com/uploads/blog/202605/05/3BS4exw0czd3Vlg.jpg"));
        kv.put(new JSONObject().put("key", "#METAURL#").put("value", "https://bot.q.qq.com"));
        ark.put("kv", kv);
