...
import com.qunxing.qq_bot_xuanji.common.dto.C2cMessageEvent;
...
public class C2cMessageHandler implements EventHandler {
    ...
    private void testMarkdown(String openid, String msgId) {
        ...
        messageSender.sendC2cMarkdown(openid, new JSONObject(md), null, msgId);
    }
    ...
    private void testMarkdownWithKeyboard(String openid, String msgId) {
        ...
        messageSender.sendC2cMarkdown(openid, new JSONObject(md), new JSONObject(kb), msgId);
    }
    ...
    private void testArk24(String openid, String msgId) {
        ...
        kv.put(new JSONObject().put("key", "#METATITLE#").put("value", "璇玑机器人"));
