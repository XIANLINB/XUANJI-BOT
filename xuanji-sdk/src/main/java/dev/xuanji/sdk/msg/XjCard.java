...
public class XjCard {
    ...
    public static XjCard create() { return new XjCard(); }
    public XjCard title(String v)  { this.title = v; return this; }
    public XjCard desc(String v)   { this.desc = v; return this; }
    public XjCard picUrl(String v) { this.picUrl = v; return this; }
    public XjCard url(String v)    { this.url = v; return this; }
