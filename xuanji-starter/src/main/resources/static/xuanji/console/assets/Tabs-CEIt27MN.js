import{f as ee,h as b,bd as ht,V as L,be as gt,bf as ye,bg as xt,bh as Z,bi as mt,l as yt,t as wt,o as Pe,al as St,F as Ct,m as Rt,bj as Tt,aG as zt,v as G,b8 as $t,c as r,a as i,b as g,d as z,e as Pt,g as ne,r as we,b0 as oe,u as Wt,k as We,aB as _t,ap as ie,a4 as Et,bk as Lt,ao as At,q as Bt,aP as Se,bl as kt,ai as jt,bm as It,b3 as Ht,bn as Ot,aW as se,x as j,aU as J,an as Ft,p as Mt,w as I,y as Q}from"./index-CniGiLyP.js";import{A as Dt}from"./Add-D_DCZfyo.js";const Nt=ye(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ye("&::-webkit-scrollbar",{width:0,height:0})]),Vt=ee({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=L(null);function n(c){!(c.currentTarget.offsetWidth<c.currentTarget.scrollWidth)||c.deltaY===0||(c.currentTarget.scrollLeft+=c.deltaY+c.deltaX,c.preventDefault())}const l=gt();return Nt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:ht,ssr:l}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...c){var x;(x=e.value)===null||x===void 0||x.scrollTo(...c)}})},render(){return b("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Ut=/\s/;function Xt(e){for(var n=e.length;n--&&Ut.test(e.charAt(n)););return n}var Gt=/^\s+/;function Yt(e){return e&&e.slice(0,Xt(e)+1).replace(Gt,"")}var Ce=NaN,qt=/^[-+]0x[0-9a-f]+$/i,Kt=/^0b[01]+$/i,Jt=/^0o[0-7]+$/i,Qt=parseInt;function Re(e){if(typeof e=="number")return e;if(xt(e))return Ce;if(Z(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=Z(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Yt(e);var l=Kt.test(e);return l||Jt.test(e)?Qt(e.slice(2),l?2:8):qt.test(e)?Ce:+e}var le=function(){return mt.Date.now()},Zt="Expected a function",ea=Math.max,ta=Math.min;function aa(e,n,l){var u,c,x,v,f,h,m=0,y=!1,T=!1,E=!0;if(typeof e!="function")throw new TypeError(Zt);n=Re(n)||0,Z(l)&&(y=!!l.leading,T="maxWait"in l,x=T?ea(Re(l.maxWait)||0,n):x,E="trailing"in l?!!l.trailing:E);function C(s){var _=u,F=c;return u=c=void 0,m=s,v=e.apply(F,_),v}function S(s){return m=s,f=setTimeout(W,n),y?C(s):v}function R(s){var _=s-h,F=s-m,M=n-_;return T?ta(M,x-F):M}function P(s){var _=s-h,F=s-m;return h===void 0||_>=n||_<0||T&&F>=x}function W(){var s=le();if(P(s))return $(s);f=setTimeout(W,R(s))}function $(s){return f=void 0,E&&u?C(s):(u=c=void 0,v)}function H(){f!==void 0&&clearTimeout(f),m=0,u=h=c=f=void 0}function k(){return f===void 0?v:$(le())}function p(){var s=le(),_=P(s);if(u=arguments,c=this,h=s,_){if(f===void 0)return S(h);if(T)return clearTimeout(f),f=setTimeout(W,n),C(h)}return f===void 0&&(f=setTimeout(W,n)),v}return p.cancel=H,p.flush=k,p}var ra="Expected a function";function na(e,n,l){var u=!0,c=!0;if(typeof e!="function")throw new TypeError(ra);return Z(l)&&(u="leading"in l?!!l.leading:u,c="trailing"in l?!!l.trailing:c),aa(e,n,{leading:u,maxWait:n,trailing:c})}const fe=yt("n-tabs"),_e={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},ca=ee({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:_e,slots:Object,setup(e){const n=Pe(fe,null);return n||wt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return b("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),oa=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},$t(_e,["displayDirective"])),be=ee({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:oa,setup(e){const{mergedClsPrefixRef:n,valueRef:l,typeRef:u,closableRef:c,tabStyleRef:x,addTabStyleRef:v,tabClassRef:f,addTabClassRef:h,tabChangeIdRef:m,onBeforeLeaveRef:y,triggerRef:T,handleAdd:E,activateTab:C,handleClose:S}=Pe(fe);return{trigger:T,mergedClosable:G(()=>{if(e.internalAddable)return!1;const{closable:R}=e;return R===void 0?c.value:R}),style:x,addStyle:v,tabClass:f,addTabClass:h,clsPrefix:n,value:l,type:u,handleClose(R){R.stopPropagation(),!e.disabled&&S(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:R}=e,P=++m.id;if(R!==l.value){const{value:W}=y;W?Promise.resolve(W(e.name,l.value)).then($=>{$&&m.id===P&&C(R)}):C(R)}}}},render(){const{internalAddable:e,clsPrefix:n,name:l,disabled:u,label:c,tab:x,value:v,mergedClosable:f,trigger:h,$slots:{default:m}}=this,y=c??x;return b("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?b("div",{class:`${n}-tabs-tab-pad`}):null,b("div",Object.assign({key:l,"data-name":l,"data-disabled":u?!0:void 0},St({class:[`${n}-tabs-tab`,v===l&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:h==="click"?this.activateTab:void 0,onMouseenter:h==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),b("span",{class:`${n}-tabs-tab__label`},e?b(Ct,null,b("div",{class:`${n}-tabs-tab__height-placeholder`}," "),b(Rt,{clsPrefix:n},{default:()=>b(Dt,null)})):m?m():typeof y=="object"?y:Tt(y??l)),f&&this.type==="card"?b(zt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),ia=r("tabs",`
