package XuanJi.adapter.qqbot.registry;
 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link XuanJi.adapter.qqbot.webhook.WebhookController} — 查找机器人和环境配置</li>
 *   <li>{@link XuanJi.adapter.qqbot.webhook.SignatureVerifier} — 获取密钥进行签名验证</li>
 *   <li>{@link XuanJi.adapter.qqbot.api.QqApiService} — 获取凭证调用 API</li>
 *   <li>{@link XuanJi.adapter.qqbot.websocket.QqBotWsManager} — 获取凭证建立连接</li>
 * </ul>
 *
 * <h3>线程安全性</h3>
