...
/**
 * 启动时调用 QQ /users/@me 接口，同步 XuanJiBot 信息到平台共享库 qqbot_botinfo 表。
 *
...
public class BotInfoSync {
    ...
    private void syncByAppId(String appId) {
        ...
        try {
            ...
            log.info("[BotInfoSync] 同步 XuanJiBot 信息: appId={}", appId);
            ...
            log.info("[BotInfoSync] XuanJiBot 信息已同步: {} ({})", username, botId);
        } catch (Exception e) {
