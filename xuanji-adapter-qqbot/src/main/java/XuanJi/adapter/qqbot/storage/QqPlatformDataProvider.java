...
public class QqPlatformDataProvider implements PlatformDataProvider {
    ...
    @Override
    public String getGroupRobotRole(String instanceId, String groupId) {
        return repo.getGroupRobotRole(instanceId, groupId);
    }

    @Override
    public List<Map<String, Object>> listGroupRobotStates(String groupOpenid) {
        return repo.listGroupRobotStatesByGroup(groupOpenid);
    }

    @Override
    public void markMessageRetracted(String instanceId, String groupId, String msgId) {
        repo.markMessageRetracted(instanceId, groupId, msgId);
    }
