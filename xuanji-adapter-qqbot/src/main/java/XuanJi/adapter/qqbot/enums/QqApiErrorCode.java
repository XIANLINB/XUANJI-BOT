package XuanJi.adapter.qqbot.enums;
 ...
 * </ul>
 *
 * @see XuanJi.adapter.qqbot.api.QqApiService 使用本枚举解析 API 错误
 */
@Getter
public enum QqApiErrorCode {
    ...
    NOT_SUPPORT_BOT_TOKEN(11262, "ErrorCheckRobot", "当前接口不支持 XuanJiBot Token 调用"),
