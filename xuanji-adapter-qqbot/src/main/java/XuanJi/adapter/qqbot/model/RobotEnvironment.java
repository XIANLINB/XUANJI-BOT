package XuanJi.adapter.qqbot.model;
 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link XuanJi.adapter.qqbot.registry.RobotRegistry} — 注册表中缓存环境配置</li>
 *   <li>{@link XuanJi.adapter.qqbot.webhook.SignatureVerifier} — 使用 ed25519Secret 进行签名验证</li>
 *   <li>{@link XuanJi.adapter.qqbot.webhook.WebhookServiceImpl} — 使用环境配置处理事件</li>
 * </ul>
 *
 * <h3>连接模式</h3>
...
public class RobotEnvironment {
    ...
    /**
     * Ed25519 密钥（AES 加密存储）
     * <p>用于 Webhook 签名验证。在 {@link XuanJi.adapter.qqbot.webhook.SignatureVerifier}
     * 注册时通过 {@link XuanJi.starter.security.util.AesUtil} 解密。
