 ...
 * <h3>使用场景</h3>
 * <ul>
 *   <li>{@link XuanJi.adapter.qqbot.registry.RobotRegistry} — 注册表中缓存机器人配置</li>
 *   <li>{@link XuanJi.adapter.qqbot.webhook.WebhookController} — Webhook 入口查找机器人</li>
 *   <li>{@link XuanJi.adapter.qqbot.api.QqApiService} — API 调用时获取凭证</li>
 *   <li>{@link XuanJi.adapter.qqbot.websocket.QqBotWsManager} — WebSocket 连接时获取凭证</li>
 * </ul>
 *
 * <h3>字段说明</h3>
 * <ul>
