...
public enum MediaKind {
    ...
    public XuanJi.api.annotation.MediaType toMediaType() {
        return switch (this) {
            case IMAGE -> XuanJi.api.annotation.MediaType.IMAGE;
            case VOICE -> XuanJi.api.annotation.MediaType.VOICE;
            case VIDEO -> XuanJi.api.annotation.MediaType.VIDEO;
            default -> null;
        };
    }
