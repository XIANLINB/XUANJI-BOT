package XuanJi.adapter.qqbot.console;
...
public class ChatController {
    ...
    private final XuanJi.adapter.qqbot.registry.RobotRegistry robotRegistry;

    public ChatController(MessageSender messageSender, QqBotRepository qqRepo,
                          XuanJi.adapter.qqbot.registry.RobotRegistry robotRegistry) {
