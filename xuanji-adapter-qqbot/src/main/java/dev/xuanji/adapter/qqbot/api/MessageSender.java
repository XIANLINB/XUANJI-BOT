...
public class MessageSender {
    ...
    private final dev.xuanji.adapter.qqbot.storage.QqBotRepository qqRepo;
    ...
    public MessageSender(QqApiService qqApiService, RobotRegistry robotRegistry,
                         dev.xuanji.adapter.qqbot.storage.QqBotRepository qqRepo) {
    ...
    public ObjectNode uploadAndSendGroupMedia(String robotId, String envType, String groupOpenid,
        ...
        try {
            ...
            dev.xuanji.core.metric.QpsMeter.hitOut();
