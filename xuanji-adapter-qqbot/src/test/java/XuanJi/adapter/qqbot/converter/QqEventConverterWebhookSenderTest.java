...
class QqEventConverterWebhookSenderTest {
    ...
    void webhook群消息_必须解析出稳定sender() {
        XuanJiBot bot = new XuanJiBot("qq:102915166", "qq", "102915166", XuanJiBot.Status.ONLINE, Set.of());
        XuanJiEvent be = QqEventConverter.convert(bot, "GROUP_MESSAGE_CREATE", "PRODUCTION",
    ...
    void 两次事件_sender稳定一致() {
        XuanJiBot bot = new XuanJiBot("qq:102915166", "qq", "102915166", XuanJiBot.Status.ONLINE, Set.of());
        XuanJiEvent b1 = QqEventConverter.convert(bot, "GROUP_MESSAGE_CREATE", "PRODUCTION",
                webhookGroupMessage(), "evt_1");
        XuanJiEvent b2 = QqEventConverter.convert(bot, "GROUP_MESSAGE_CREATE", "PRODUCTION",
